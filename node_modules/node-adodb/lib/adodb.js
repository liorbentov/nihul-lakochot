            ...
            if (recordset.BOF && recordset.EOF) {
                ...
                while (!recordset.EOF) {
                    ...
                    for (var i = 0; i < fields.length; i++) {
                        ...
                        var field = recordset(fieldname).value;
                        //LegalChars = new RegExp("^[a-zA-Z-_ ’''‘\.,0-9]+$");
                        //hebLegalChars = new RegExp("^[0-9\u0590-\u05FF\u0027\u0020\u002F]+$");
                        item[fieldname] = encodeURIComponent(recordset(fieldname).value); 
                        if (fieldname == "birthdate"){
                            if ((typeof recordset(fieldname).value) != 'date'){
                                item[fieldname] == null;    
                            }
                            else{
                                var newDate = "";
                                var day = (new Date(recordset(fieldname).value).getDate());
                                newDate += (day < 10 ? "0" : "") + day;
                                day = (new Date(recordset(fieldname).value).getMonth()) + 1;
                                newDate += "/" + (day < 10 ? "0" : "") + day;
                                day = (new Date(recordset(fieldname).value).getFullYear());
                                newDate += "/" + day;
...
//ADODB[WScript.Arguments(0)](WScript.Arguments(1));
